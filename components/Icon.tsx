...
import { Github, Linkedin, Twitter, Mail, ExternalLink, Code2, Menu, X, ArrowRight, Calendar, Phone, ChevronLeft, ChevronRight } from 'lucide-react';
...
export const Icon: React.FC<IconProps> = ({ name, size = 24, className = '' }) => {
  switch (name) {
    ...
    case 'chevron-left': return <ChevronLeft size={size} className={className} />;
